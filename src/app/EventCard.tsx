 ...
 *                       participant CAPACITY is not shown at all any more — every card,
 *                       your own included, prints the bare rider count.
 */
    ...
    >
      ...
      <div className={styles.footer}>
        ...
        {/* Rider count — approved + pending, from GET /events (server's toEventSummary). The
            bare count ("7") for every viewer, the ride's own creator included: "we will see
            participants only and not how many from total places". Falls back to "soon" only
            for an older server / cached row that omits the count. */}
